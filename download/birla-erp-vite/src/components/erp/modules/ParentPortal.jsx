...
import { Heart, IndianRupee, Bus, Stethoscope, MessageSquare, BookOpen, BarChart3, TrendingUp, Calendar, CreditCard, Phone, MapPin, Plus, X, Shield, FileText, Activity, Star, Users, Clock, ArrowUpRight, AlertCircle, CheckCircle2, UserCheck, Award, GraduationCap, ClipboardList, Send, HeartPulse, Navigation } from 'lucide-react'
import {
    ...
    <motion.div variants={containerVariants} initial="hidden" animate="show" className="p-4 lg:p-6 space-y-6 max-w-[1600px] mx-auto">
      ...
      {activeTab === 'communication' && (
        <motion.div variants={itemVariants} className="space-y-4">
          <div className="rounded-2xl border border-border bg-card p-5">
            <h3 className="text-base font-semibold text-foreground flex items-center gap-2 mb-3">
              <MessageSquare className="w-4 h-4 text-birla-cyan" />Messages from GraduationCap
            </h3>
            <div className="space-y-2 max-h-96 overflow-y-auto">
              {[
                ...
                { title: 'Holiday Notice', message: 'GraduationCap will remain closed on 14th March (Holi).', date: '28 Feb 2026', type: 'Holiday' },
              ].map((msg, i) => (
