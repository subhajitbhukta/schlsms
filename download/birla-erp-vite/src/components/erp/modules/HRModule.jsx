...
import { Briefcase, Users, Clock, TrendingUp, TrendingDown, ArrowUpRight, Plus, Download, Search, Filter, Award, Calendar, Bell, ChevronRight, Save, UserPlus, FileText, BarChart3, PieChart as PieChartIcon, UserCheck, UserX, Building2, Phone, Mail, MapPin, Star, Target, GraduationCap, Banknote, Heart, Shield, ClipboardList, FileBarChart, DollarSign, AlertTriangle, CheckCircle2, XCircle, Settings, Globe, BookOpen, Megaphone, Smile, Frown, Meh, Handshake, FileSpreadsheet, CreditCard, QrCode, ScanLine, Printer, RefreshCw, Droplets, AlertCircle, Eye, Loader2, Hash, Edit, Trash2 } from 'lucide-react'
import {
...
import { TEACHER_DB } from '../shared/QRStudentLookup'
import { TEACHERS, TEACHER_ASSIGNMENTS, SUBJECTS, CLASSES, SECTIONS, getTeacherWorkload, getClassSubjectCoverage, getAssignmentStats } from '../../../data/teacherAssignments'
  ...
  return (
    <div className="w-72 bg-gradient-to-br from-[#0A1628] via-[#0f2340] to-[#0A1628] rounded-2xl overflow-hidden shadow-2xl border border-[#C8A45C]/30">
      ...
      <div className="bg-gradient-to-r from-[#C8A45C] to-[#d4b76a] px-4 py-2 text-center">
        <p className="text-[10px] font-bold text-[#0A1628] tracking-wider uppercase">Birla Open Minds International GraduationCap</p>
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="rounded-2xl border border-[#C8A45C]/30 bg-gradient-to-br from-[#0A1628] to-[#0f2340] p-5 text-white">
      <div className="text-center border-b border-[#C8A45C]/20 pb-3 mb-3">
        <p className="text-xs font-bold text-[#C8A45C] tracking-wider uppercase">Birla Open Minds International GraduationCap</p>
