...
import { Users, UserCheck, IndianRupee, Briefcase, TrendingUp, TrendingDown, GraduationCap, BookOpen, Calendar, Clock, AlertTriangle, CheckCircle2, BarChart3, Activity, Shield, FileText, ArrowUpRight, ArrowDownRight, Building2, Bus, Sparkles, ChevronRight, Hash, Plus, X, MessageSquare, PenTool, Target, Zap, Globe, ClipboardCheck, CreditCard, Award, Star, PieChart as PieChartIcon, Settings, UserPlus, Bell, HeartPulse, Stethoscope, Armchair } from 'lucide-react'
import {
...
export default function GraduationCapAdminDashboard() {
