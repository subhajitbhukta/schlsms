...
import { UserCheck, ClipboardList, FileQuestion, MessageSquare, StickyNote, Trophy, Calendar, BarChart3, TrendingUp, Brain, Target, Plus, X, Clock, Award, ArrowUpRight, BookOpen, Sparkles, Palette, Zap, Activity, Send, CheckCircle2, Star, Shield, FileText, PieChart as PieChartIcon, GraduationCap, AlertCircle, Upload, PenLine, Heart, Megaphone } from 'lucide-react'
import {
...
const achievementsData = [
  ...
  { title: 'Inter-GraduationCap Debate Winner', type: 'Co-Curricular', date: '28 Jan 2026', badge: '🥇', level: 'Inter-GraduationCap' },
  { title: 'Best Coder Award - CodeFest', type: 'Academic', date: '10 Mar 2026', badge: '🏆', level: 'GraduationCap' },
  { title: 'Cricket Tournament - Runner Up', type: 'Sports', date: '05 Mar 2026', badge: '🥈', level: 'Zonal' },
  { title: 'Art Exhibition - Special Mention', type: 'Arts', date: '20 Feb 2026', badge: '🌟', level: 'GraduationCap' },
  { title: '100% Attendance - Term 1', type: 'Attendance', date: 'Dec 2025', badge: '✅', level: 'GraduationCap' },
]
