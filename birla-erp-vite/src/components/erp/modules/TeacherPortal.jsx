...
import { BookOpen, ClipboardList, Users, Calendar, Clock, BarChart3, PieChart as PieChartIcon, Target, Brain, FileText, Plus, X, CheckCircle2, Zap, Award, Sparkles, TrendingUp, ArrowUpRight, Search, Phone, Mail, MessageSquare, PenTool, Save, Send, Eye, ChevronRight, Activity, Star, UserCheck, Bell, GraduationCap, Monitor, Settings, FileQuestion, Upload, Lightbulb, AlertTriangle, Mic, FlaskConical, MapPin, Tag, Edit, MessageCircle, HandMetal, Presentation, Download, Printer, IndianRupee } from 'lucide-react'
import {
...
import { TEACHER_ASSIGNMENTS, TEACHERS, getTeacherWorkload } from '../../../data/teacherAssignments'
    ...
    <motion.div variants={containerVariants} initial="hidden" animate="show" className="p-4 lg:p-6 space-y-6 max-w-[1600px] mx-auto">
      ...
      <motion.div variants={itemVariants} className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">Dr. Priya Menon &bull; Birla Open Minds International GraduationCap</p>
        </div>
      </motion.div>
