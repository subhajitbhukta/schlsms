...
import {
  ClipboardList, Users, FileText, Search, Plus, Eye,
  GraduationCap, ArrowUpRight, Clock, CheckCircle2, XCircle,
  Download, Phone, Calendar, BookOpen, IndianRupee, Activity,
  BarChart3, PieChart as PieChartIcon, Target, UserCheck, MessageSquare,
  TrendingUp, FileCheck, CreditCard, MapPin, Star,
  UserPlus, CalendarCheck, X, Save, Hash, Shield,
  FormInput, BadgeCheck, Building2
} from 'lucide-react'
import {
    ...
    <motion.div variants={containerVariants} initial="hidden" animate="show" className="p-4 lg:p-6 space-y-6 max-w-[1600px] mx-auto">
      ...
      <motion.div variants={itemVariants} className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
        <div>
          ...
          <p className="text-[11px] text-muted-foreground mt-0.5">Birla Open Minds International School &bull; Academic Session 2025-26</p>
        </div>
          ...
          {showForm === 'admission' && (
            <motion.div variants={itemVariants} className="rounded-2xl border border-border bg-card p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div><label className={labelClass}>Previous School</label><input className={inputClass} placeholder="Previous school name" value={admissionForm.previousSchool} onChange={e => setAdmissionForm({...admissionForm, previousSchool: e.target.value})} /></div>
