...
import {
  ...
  FileCheck, UserCheck, ListChecks, Palette,
  Printer, Stamp, Signature, QrCode, ScanLine,
  TableProperties, FileSpreadsheet, Download, Upload,
  AlertTriangle, RotateCcw, Send, FileDown, XCircle
} from 'lucide-react'
import {
          ...
          <div className="rounded-2xl border-2 border-birla-gold/30 bg-card overflow-hidden">
            ...
            <div className="p-5 border-b border-border">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {[['Class Teacher','Mrs. Kavita Sharma'],['Exam Controller','Dr. Suresh Babu'],['Principal','Birla Open Minds Int. School']].map(([title, name], i) => (
            ...
            {tcStudent && (
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  ...
                  <div><label className={labelClass}>Games & Sports</label><select value={tcForm.gamesSports} onChange={e => setTcForm({...tcForm, gamesSports: e.target.value})} className={inputClass}><option>Participated</option><option>Not Participated</option><option>Represented School</option><option>Outstanding</option></select></div>
